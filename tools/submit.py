...
if __name__ == '__main__':
    ...
    first = sanitize(input("Please enter your first (given) name: "), 'first')
    last  = sanitize(input("Please enter your last (family) name: "), 'last')
    uid   = sanitize(input("Please enter your student ID (A#): "), 'uid')
